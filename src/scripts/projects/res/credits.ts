export default `[
  {
    ...
    titles: [
      {
        title: "Head of Minecraft",
        names: ["Helen Chiang"],
      },
      {
        title: "Head of Stockholm Studio",
        names: ["Ulrika Höjgård"],
      },
    ],
  },
  {
    ...
    titles: [
      {
        title: "Chief Creative Officers",
        names: ["Jens Bergensten", "Saxs Persson"],
      },
      {
        title: "Game Directors",
        names: ["Agnes Larsson", "Måns Olson"],
      },
      {
        title: "Creative Director",
        names: ["Jesse Merriam", "Magnus Nedfors", "Torfi Frans Olafsson"],
      },
      {
      ...
      },
      {
        ...
        names: ["Michael Harnisch"],
      },
      {
        title: "Lead Game Designers",
        names: ["Rob Poerschke", "Robin V Vincent"],
      },
      {
    ...
    titles: [
      {
        ...
        names: ["Michael W Weilbacher", "Mike Carlson"],
      },
      {
        title: "Head of Services and Ops Engineering",
        names: ["Vince Curley"],
      },
      {
        title: "Head of Game Engineering",
        names: ["Åsa Bredin"],
      },
      {
        title: "Head of Creator Platform Engineering",
        names: ["Jason Cahill"],
      },
      {
        title: "Director of Franchise Quality",
        names: ["Matthew Ng"],
      },
      {
      ...
      },
      {
        ...
        names: [
          ...
          "Isaac Dayton",
          "Jacek Wołkowicz",
          "James Vanderheiden (Insight Global, Inc)",
          "Jimmy Almkvist",
          "Johannes Busch",
          "Johannes Sundqvist",
      ...
      {
        title: "Lead UI Developers",
        names: ["Eric Grimsborn", "Oleg Kozitsyn", "Paulo Ragonha"],
      },
      {
        title: "UI Developers",
        names: [
      ...
      {
        title: "Launcher Developers",
        names: ["Matthew Phair", "Patrick Tobin", "Andrew Hewitson"],
      },
      {
        title: "Lead Architects",
        names: ["Greg Snook", "Peter M. Wiest"],
      },
      {
        title: "Architects",
        names: ["Dom Humphrey", "Robert Sanchez"],
      },
      {
        title: "Lead Bedrock Software Developers",
        names: [
          "Bill Carlson",
          "Bryan Yeo",
          "Chad C Meyers",
      ...
      {
        title: "Bedrock Software Developers",
        names: [
          "A.J. Fairfield",
          "Aaron Woodward",
          "Adrian T Orszulak",
          ...
          "John Countouriotis (Populus Group, LLC)",
          "Jonathan R Hoof",
          "Joseph Kichline (Insight Global, Inc)",
          "Kari C Whiteside",
          "Kento Murawski (Insight Global, Inc)",
          "Kirby Duncan (Insight Global, Inc)",
          "Kristin A Siu",
          "Larry Ukaoma",
          "Li Yang (Insight Global, Inc)",
          "Loren J. Merriman (Kalvi Consulting Service)",
          "Lucas Carpenter (Collabera)",
          "Lucy Lauzon (Collabera)",
          "Matt Staubus",
      ...
      },
      {
        ...
        names: ["Joel Bergman", "Mark Jawad"],
      },
      {
        title: "Realms Software Engineers",
        names: ["Nicholas John Curtis", "Roman Timurson (Insight Global, Inc)"],
      },
      {
      ...
      {
        title: "Service Software Engineers",
        names: [
          ...
          "Maria Katsourani",
          "Martin Pola",
          "Matt Shore (Insight Global, Inc)",
          "Michael Kranz",
          "Mike Swartz",
          "Nicholas Burlingame (Insight Global, Inc)",
          "Nico Suc",
          "Patrick McGannon",
          "Petter Gisslen",
          "Rick Payne (Insight Global, Inc)",
          "Simon Fagerholm",
          "Stefan Torstensson",
          "Theodor Fleming",
        ],
  ...
  },
  {
    ...
    titles: [
      ...
      },
      {
        ...
        names: ["Daniel Rosenfeld", "Kumi Tanioka", "Lena Raine"],
      },
    ],
  },
  {
    ...
    titles: [
      ...
      },
      {
        ...
        names: [
          ...
          "Dylan Sunkel (Collabera)",
          "Erin Caswell (Randstad)",
          "Florian Decupper",
          "Jacob Lee (Aquent LLC)",
          "Jan Cariaga",
      ...
      {
        title: "3D Artists",
        names: ["Brendan Sullivan", "Christian Nordgren"],
      },
      {
      ...
      },
      {
        ...
        names: [
          "Adrian Leon (TEKsystems, Inc)",
          "Dalila Copeland (Randstad)",
          "Javier Rodriguez (Insight Global, Inc)",
        ],
      },
      {
        ...
        names: [
          ...
          "Lauren Kohler (TEKsystems, Inc)",
          "Rudy Solidarios (Randstad)",
        ],
      },
      {
        title: "Animator",
        names: ["Patrick Rodes (Randstad)"],
      },
      {
        title: "Art Manager",
        names: ["Samir Belarbi"],
  ...
  },
  {
    ...
    titles: [
      {
        title: "Head of Creator Platform",
        names: ["Deanna Hearns"],
      },
      {
        title: "Head of Game Production",
        names: ["John Thornton"],
      },
      {
        title: "Head of Minecraft China",
        names: ["Travis Howland"],
      },
      {
        title: "Head of Business Engineering",
        names: ["Ryan B Cooper"],
      },
      {
        title: "Head of Games",
        names: ["Sara Jansson Bach"],
      },
      {
        title: "Head of Creator Marketplace",
        names: ["Aaron J Buckley"],
      },
      {
        title: "Head of Minecraft Education",
        names: ["Allison Matthews"],
      },
      {
        title: "Director of Minecraft.net",
        names: ["Saher M Hirji"],
      },
      {
      ...
      },
      {
        ...
        names: [
          ...
          "DJ Stiner",
          "Dom Arcamone",
          "Graham Logan (Randstad)",
          "Hai Shi",
          "Halishia Chugani",
          "Hedwig Andra Laza",
          "Jewel Chukwufumn, Ifeguni",
          "John Garcia (Collabera)",
          "Kara Kono",
          "Kasia Swica",
          "Katie Ellison",
          "Kelly Henckel",
          ...
          "Nikoo Jorjani",
          "Riccardo Lenzi",
          "Riley Manns Insight Global, Inc)",
          "Sebastian Falk",
          "Stephen A Scott",
          "Tia Marie Dalupan-Wong",
          "Todd Baldwin",
          "William Cooper",
        ],
      },
      ...
      {
        title: "Release Management Lead",
        names: ["David Fries"],
      },
      {
        title: "Release Managers",
        names: ["Andrew Pritchard", "Josh Mulanax", "Joshua Bullard"],
      },
      {
      ...
      },
      {
        ...
        names: ["Joshua Jones (Insight Global, Inc)"],
      },
    ],
  },
  {
    section: "Brand Creative",
    titles: [
      {
        title: "Creative Director",
        names: ["Markus Toivonen"],
      },
      {
        title: "Head of Creative Production",
        names: ["Isabella Arningsmark"],
      },
      {
        title: "Lead Producers",
        names: ["Christine Platon", "Milo Bengtsson", "Sarah Carton"],
      },
      {
        title: "Producers",
        names: [
      ...
      },
      {
        ...
        names: ["Martin Johansson", "Antti Meriluoto"],
      },
      {
        title: "Art Directors",
        names: ["Johan Aronsson", "Julian Kerr", "Ninni Landin", "Seung Sung"],
      },
      {
        title: "Art Lead",
        names: ["Amanda Ström"],
      ...
      {
        title: "Artists",
        names: ["Morten Rasmussen", "Markus Frost"],
      },
      {
        title: "Graphic Designer",
        names: ["Afshin 'Affe' Piran"],
      },
      {
        title: "3D Artist / Motion Graphic Designer",
        names: ["Jesper Hallin"],
      },
      {
        title: "Gameplay Capture Artist",
        names: ["Husein Kurbegovic"],
      },
      {
        title: "Product Designers",
        names: ["Adrian Ward", "Débora Martins", "Filip Thoms", "Sherin Kwan"],
      },
      {
        title: "Publishing Editor",
        names: ["Alex Wiltshire"],
      },
      {
        title: "Director of Creative Communications",
        names: ["Owen Jones"],
      },
      {
        title: "Social Media Managers",
        names: ["Julian Tunru", "Ross Keatley"],
      },
      {
  ...
  },
  {
    ...
    titles: [
      ...
      {
        title: "Senior Media Producers",
        names: ["Carina Petersson"],
      },
      {
        title: "Producers",
        names: ["Sofia Orrheim"],
      ...
      {
        title: "Social Media Managers",
        names: ["Alex Fleck (Adecco)", "David Ramos (Collabera)"],
      },
      {
        title: "Communication Managers",
        names: ["Holly Amber Smith", "Rebecca Gordius"],
      },
      {
        title: "Assembly Media, Inc",
        names: [
          "Adam Pannel",
          "Erin Dwyer",
          "Tory Edelman",
      ...
      {
        title: "Sr. Social Media Lead",
        names: ["Sara Reiner"],
      },
      {
        title: "Web Design",
        names: ["Paul Madlon (Ten Gun Design, Inc)"],
      },
      {
        title: "Web Content Manager",
        names: ["Joe Corrigan (Ten Gun Design, Inc)"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    titles: [
      {
        title: "Franchise Chief Operations Officer",
        names: ["Annie Chenn"],
      },
      {
        title: "Head of Stockholm Operations",
        names: ["Sheila Ho"],
      },
      {
        title: "Executive Strategic Advisor",
        names: ["Jonas Mårtensson"],
      },
      {
        title: "Head of Franchise Operations",
        names: ["Josh Bliggenstorffer"],
      },
      {
      ...
      {
        title: "HR Directors",
        names: ["David Hill", "Maja Samuelsson"],
      },
      {
        title: "Sr HR Business Partners",
        names: ["Maja Samuelsson", "Nia Parker"],
      },
      {
      ...
      },
      {
        ...
        names: ["Erin Decker", "Lisa Liu", "Rachel Cox", "Theresa Chin"],
      },
      {
        title: "Front of House",
        names: ["Eliza Lancelot", "Felicia Björn Nordling"],
      },
      {
        title: "IT Managers",
        names: ["Cesar Sima Falck", "Jason Perry Minard"],
      },
      {
        title: "IT",
        names: [
      ...
      {
        title: "Lead Automation Support",
        names: ["Matthew C. Moreno"],
      },
      {
        title: "Automation Support",
        names: [
          "Chris Ilson (Collabera)",
          "Corey Smith (Insight Global, Inc)",
          "Gregory D Searing (WaferWire Cloud Technologies)",
          "Johnny Cocks (Collabera)",
  ...
  {
    section: "Data and Analytics",
    titles: [
      {
        title: "Head of Data Science and Analytics",
        names: ["Francisco Rius"],
      },
      {
      ...
      {
        title: "Data and Analytics Lead",
        names: ["Natalie Selin"],
      },
      {
        title: "Analytics Environment Manager",
        names: ["Troy Henke"],
      },
      {
        title: "Data Science",
        names: [
          ...
          "Grant Jenkins",
          "Jake Kelly",
          "Jonathan Lau (KellyMitchell Group, Inc)",
          "Matthew Skirvin",
          "Max Davidson",
          "Swathi Sivadas",
          "Tong Shen (KellyMitchell Group, Inc)",
          "Zach Golkhou (KellyMitchell Group, Inc)",
        ],
      },
      {
  ...
  },
  {
    ...
    titles: [
      {
        title: "User Research Studio Lead",
        names: ["Jerome Hagen"],
      },
      {
        title: "User Researcher",
        names: ["Melissa Boone", "Olga Zielinska", "Pablo Morales"],
      },
    ],
  },
  {
    section: "Business & Licensing",
    titles: [
      {
        title: "Head of Franchise Business & Growth",
        names: ["Scott Dell'Osso"],
      },
      {
        title: "Head of Franchise Development",
        names: ["Kayleen Walters"],
      },
      {
        title: "Head of Social Impact & Partnerships",
        names: ["Ada Duan"],
      },
      {
      ...
      {
        title: "Directors of Business Development",
        names: [
          "Bob Brennecke",
          "Federico San Martin",
          "Jeremy Snook",
      ...
      {
        title: "Directors of Business Management",
        names: ["Amy Zou", "Michelle Hua"],
      },
      {
        ...
        names: [
          ...
          "Eve Vashkus",
          "Julie Olden",
          "Laylah Stanley Si Bulman",
          "Leslie Tullis",
          "Maru Zamora",
          "Morgan Farrar (Apex Systems, Inc)",
          "Nedra Wilson",
          "Nichole Green",
          "Stephanie Louie",
          "Tess N Opincarne (Amaxra)",
          "Wendy Gorton",
        ],
      },
      {
      ...
      {
        title: "Brand Assurance Managers",
        names: [
      ...
      },
      {
        ...
        names: ["Keiko Ramer (Apex Systems, Inc)", "Kristin Grein"],
      },
      {
      ...
      {
        title: "Director of Partner Management",
        names: ["Todd Stevens"],
      },
      {
      ...
      },
      {
        ...
        names: ["Oskar Thysell", "Niclas Fredriksson"],
      },
      {
        title: "Program Managers",
        names: [
          "Bryan G. Bonham",
          "Christopher Dauchot (Insight Global, Inc)",
          "Emily Carlson",
          "Georgia Marra",
          "Gregory Walls (Excell)",
          "Helene Brown",
          "John C. Mercil (CompuCom Systems, Inc)",
          "Joshua Ayala (Insight Global, Inc)",
      ...
      {
        title: "Studio Compliance Lead",
        names: ["Eric Odell-Hein"],
      },
      {
        title: "Studio Compliance Analyst",
        names: ["Justin Ray (Design Laboratory, Inc)"],
      },
      {
        title: "Intellectual Property Enforcement Lead",
        names: ["Gaylon Blank"],
      },
      {
        title: "Category Managers",
        names: ["Audrey Searcy", "Emily Clock", "Hanna Willis", "Shabnam Elmi"],
      },
    ],
  },
  {
    section: "Player Operations",
    titles: [
      {
        title: "Director of Player Support",
        names: ["Anne Quaranta"],
      },
      {
        title: "Director of Community",
        names: ["Nea Aime Rollan"],
      },
      {
        ...
        names: [
          ...
          "Joel Sasaki",
          "Kristina Horner",
          "Lindsey Schaal (Apex Systems, Inc)",
          "Matt Gartzke",
          "Trella Rath (Corestaff)",
        ],
      },
      {
        title: "Customer Support Program Manager",
        names: ["Jon-Eric L. Swigart (Collabera)"],
      },
      {
        title: "Customer Support Lead",
        names: ["Jen Pedersen", "Justin Putnam (TEKsystems, Inc)"],
      },
      {
        title: "Customer Support",
        names: ["Andrew Lee (Apex Systems, Inc)"],
      },
    ],
  },
  {
    ...
    titles: [
      {
        ...
        names: ["Jessica Freeman"],
      },
      {
        title: "Marketing Directors",
        names: ["Fergus Lynch", "Jeanie DuMont"],
      },
      {
        ...
        names: [
          ...
          "Melissa Jenkins (Ten Gun Design, Inc)",
          "Nathaniel Wipfler",
          "Nick Ketter",
          "Sara Cornish",
        ],
    ...
    titles: [
      {
        ...
        names: ["Marina Kostesic"],
      },
      {
        title: "Finance Manager",
        names: ["Evan Dowdell", "Katarina Norlander"],
      },
      {
        title: "Senior Financial Accountant",
        names: ["Josefina Axelsson"],
      },
      {
      ...
      },
      {
        ...
        names: ["Stefan Lyrmark"],
      },
    ],
  },
  {
    section: "Studios Quality Team - Microsoft",
    titles: [
      {
        title: "Director of Quality",
        names: ["Jimmy Bischoff"],
      },
      {
        title: "Studios Quality Manager",
        names: ["Tyler Moeller"],
      },
      {
        title: "Quality Leads",
      ...
      {
        title: "Quality Data Analysis & Engineering",
        names: ["Chelsi Hohnbaum", "Christian Koguchi", "Lisa Porter"],
      },
      {
      ...
      },
      {
        ...
        names: [
          ...
          "Allen Horton – Technology and Infrastructure",
          "Andrew Franklin – Outsourcing Manager",
          "Dante Carrasco – Business Manager",
          "David Boker – Director XGS Business Operations",
          "James Fry – Quality Manager, Studios Quality UK",
          "Jonny Stacey – Data Engineering, Studios Quality UK",
          "Kenna Gillooly – Executive Business Administrator",
          "Zoe Harrop – Senior Business Coordinator, Studios Quality UK",
        ],
      },
    ],
  },
  {
    section: "Studios Quality Team - US Teams",
    titles: [
      {
        title: "Test Manager",
        names: ["Tom Dieterich (Experis) - Test Manager, Tempe"],
      },
      {
        title: "Software Test Engineering Leads",
        names: ["Barry Doyle (Insight Global, Inc)", "Maria Berube (Experis)"],
      },
      {
        title: "Software Test Engineers",
        names: [
      ...
      },
      {
        ...
        names: [
          ...
          "Ben Farley (Experis) – Test Manager, Tempe",
          "Brian Canning (Experis) – Test Manager, Tempe",
          "Carol Stearns (Experis)",
          "Erica Davis (Experis)",
          "Frank Criscione (Experis)",
          "Gavin Kennedy (Experis)",
          "Jay Piette (Experis) – Test Manager, Tempe",
          "Jeffrey Guyton (Insight Global, Inc) – Account Manager",
          "Julie Loucks (Experis)",
          "Lucas Rathburn (Experis)",
          "Mark Medlock (Experis)",
          "Paul Gradwohl (Experis)",
          "Theresa Pudenz (Experis)",
          "Thomas Hanson (Experis)",
          "Zachary Bohnenkamp (Experis) – Program Manager",
        ],
      },
    ],
  },
    ...
    titles: [
      {
        ...
        names: [
          ...
          "Julian Gough - Writer",
          "Kent Christian Jensen – Creature Developer",
          "Reza Elghazi - Developer Account Manager",
          "Stephanie Golden (Insight Global, Inc) – Account Manager",
          "The PlayFab Team",
          "The Xbox Live Team",
  ...
  {
    section: "Development Partner: Lionbridge Quality - Poland Team",
    titles: [
      {
        title: "Test Director",
        names: ["Michał Błoński (Lionbridge)"],
      },
      {
        title: "Senior Global Test Manager",
        names: ["Grzegorz Kohorewicz (Lionbridge)"],
      },
      {
        title: "Senior Test Manager",
        names: ["Mateusz Kałuża (Lionbridge)"],
      },
      {
        title: "Test Leads",
        names: ["Beata Jastrzębska (Lionbridge)"],
      },
      {
        title: "Team Leads",
        names: [
      ...
      },
      {
        ...
        names: ["Łukasz Mikusek (Lionbridge)"],
      },
      {
        title: "Software Test Engineers",
        names: [
      ...
      {
        title: "Compliance Software Test Engineers",
        names: [
          "Adam Ronowski (Lionbridge)",
          "Maciej Rodak (Lionbridge)",
      ...
      },
      {
        title: "Special Thanks",
        names: [
          "Dariusz Sokołowski (Lionbridge)",
          "Evan Wright (Lionbridge)",
          "Matt Whiting (Lionbridge)",
          "Michael Friend (Lionbridge)",
          "Szymon Walicki (Lionbridge)",
          "Tomasz Pucyk (Lionbridge)",
          "Tugdual Delisle (Lionbridge)",
        ],
      },
    ],
  },
  {
    section: "Quality - UK Team",
    titles: [
      {
        title: "Test Manager",
        names: ["Richard H. Jones (Lionbridge)"],
      },
      {
        title: "Compliance Test Engineer",
        names: ["Lee-Roy Dunn (Lionbridge)", "Nick Dorsett (Lionbridge)"],
      },
      {
        title: "Data Engineering",
        names: ["Patrick Fraioli"],
      },
    ],
  },
  {
    section: "Development Partner: BBI",
    titles: [
      {
        title: "Programmer",
        names: [
      ...
      {
        title: "QA Analyst",
        names: ["Jamie Cheung", "Paul Pera"],
      },
    ],
  },
  {
    section: "Development Partner: Disbelief",
    titles: [
      {
        title: "President",
        names: ["Steve Ellmore"],
  ...
  {
    section: "Development Partner: Skybox",
    titles: [
      {
        title: "",
        names: [
  ...
  {
    section: "Development Partner: Red Lens Games",
    titles: [
      {
        title: "President",
        names: ["Jared Noftle"],
      ...
      {
        title: "Dev Lead",
        names: ["Arend Danielek", "Steve Chiavelli"],
      },
      {
        title: "Tech Lead",
        names: ["Nathan Carlson", "Ryan Edgemon"],
      },
      {
        title: "Software Engineers",
        names: [
  ...
  {
    section: "Development Partner: Virtuosity",
    titles: [
      {
        title: "Game Developers",
        names: [
          "Aishwarya Jayabal (Virtuosity)",
          "Ganesh Sethy (Virtuosity)",
          "Janani Senrayaperumal (Virtuosity)",
          "Maha Srinivasan (Virtuosity)",
          "Nandha Arulanandam (Virtuosity)",
          "Nazia Nazia (Virtuosity)",
          "Packiyanath Sivathanu (Virtuosity)",
          "Prabhu Venkatraman Iyer (Virtuosity)",
          "Shagun Sharma Tamta (Virtuosity)",
          "Shanmugam Sanjay (Virtuosity)",
          "Sheena Mathew (Virtuosity)",
          "Sripriya Gunasekaran (Virtuosity)",
          "Sriram Sreenivasan (Virtuosity)",
          "Sumit Kumar Suman (Virtuosity)",
          "Swati S Thakar (Virtuosity)",
          "Vivek Kumar (Virtuosity)",
        ],
      },
      {
        title: "Producers",
        names: ["Chokkalingam Ramu Kuppaswamy (Virtuosity)"],
      },
    ],
  },
  {
    section: "Mojang Alumni",
    titles: [
      {
        title: "Original Creator of Minecraft",
        names: ["Markus Persson"],
      },
      {
        title: "Head of Minecraft",
        names: ["Matt Booty"],
      ...
      {
        title: "Head of Minecraft Atlas",
        names: ["Deirdre Quarnstrom"],
      },
      {
      ...
      },
      {
        ...
        names: ["Karin Severinson"],
      },
      {
        title: "Chief Product Officer",
        names: ["Olof Carlson Sandvik"],
      },
      {
      ...
      {
        title: "Chief Technology Officer",
        names: ["Rikard Herlitz"],
      },
      {
        title: "Technical Director Games",
        names: ["Jason Major", "Kristoffer Jelbring"],
      },
      {
        title: "Game Designers",
        names: [
          "Miko Charbonneau",
          "Brandon Franklin (Insigt Global, Inc)",
      ...
      {
        title: "Lead Game Developers",
        names: ["Niklas Börestam", "Piotr Kundu"],
      },
      {
        title: "Game Developers",
        names: [
          ...
          "Jakob Pogulis",
          "Jeff 'Dextor' Blazier",
          "Jeffrey Kumley (Insight Global, Inc)",
          "Joachim Larsson",
          "Johan Bernhardsson",
          "John Haynes",
          "Jonas Bergström",
      ...
      {
        title: "Launcher",
        names: ["Anders Rosén", "Carl Westin", "David Zevallos"],
      },
      {
        title: "Architects",
        names: ["Michael Seydl", "Mike Frost", "Tommaso Checchi"],
      },
      {
        title: "Lead Bedrock Software Developers",
        names: [
      ...
      {
        title: "System Engineers",
        names: ["Robert Thresher (Collabera)"],
      },
      {
      ...
      {
        title: "Art Directors",
        names: ["Brad Shuber", "Logan Lubera", "Ola Lanteli", "Wiktor Persson"],
      },
      {
        title: "Art Lead",
        names: ["Sarah Kisor"],
      ...
      {
        title: "3D/VFX",
        names: ["Elin Ölund Forsling", "Jakob Gavelli", "Marco Vale"],
      },
      {
      ...
      {
        title: "Lead Graphic Designers",
        names: ["Christine Gutierrez"],
      },
      {
        title: "Additional Graphics",
        names: ["Jonatan Pöljö", "Mariana Graham Ramirez"],
      },
      {
        title: "Motion Graphics Designer",
        names: ["Gabe Philbin (Randstad)"],
      },
      {
        title: "Sound Designers",
        names: ["Kevin Martinez", "Shauny Jang (Insight Global, Inc)"],
      },
      {
      ...
      },
      {
        ...
        names: ["Jennifer Hammervald"],
      },
      {
        title: "Head of Creative Communications",
        names: ["Thomas Wiborgh"],
      },
      {
        title: "Director of Brand",
        names: ["Jonathan Symington"],
      },
      {
        title: "Head of Creative Production",
        names: ["Katharina Hautz"],
      },
      {
        title: "User Experience Design Director",
        names: ["Stephen Whetstine", "Tobias Ahlin"],
      },
      {
      ...
      {
        title: "Directors of Business Management",
        names: ["Stephen McHugh"],
      },
      {
        title: "Chief of Staff",
        names: ["Andrew J. Adamyk"],
      },
      {
        title: "Executive Business Administrators",
        names: [
      ...
      },
      {
        ...
        names: ["Shae M. Flanigan (C2S Technologies, Inc)"],
      },
      {
      ...
      {
        title: "Reception",
        names: ["Chaimae Truving"],
      },
      {
        title: "Data Science & Analytics Lead",
        names: ["Warren Durrett"],
      },
      {
      ...
      {
        title: "Data Engineering",
        names: ["Sachin Dekate (Design Laboratory, Inc)"],
      },
      {
        title: "Directors of Business Development",
        names: ["Cherie D Lutz"],
      ...
      {
        title: "Directors of Business Planning",
        names: ["Adam Tratt"],
      },
      {
        title: "Business Managers",
      ...
      {
        title: "Minecraft Content Coordinators",
        names: ["Adam Martinsson", "Andreas Thomasson", "Sara Lempiäinen"],
      },
      {
        title: "Program Manager",
        names: [
          "Amber Wu (Shang Hai Wei Chuang Ruan Jian)",
          "Gregory Walls (CompuCom Systems, Inc)",
      ...
      {
        title: "Creative Director",
        names: ["John Hendricks"],
      },
      {
        title: "Media Director",
        names: ["Hans Abrahamsson"],
      },
      {
        title: "Creative Communications Assistant",
        names: ["Emily Richardson"],
      },
      {
        title: "Head of Social Media",
        names: ["Amelia Dale", "Alice Löfgren"],
      },
      {
        title: "Head of Player Operations",
        names: ["Aubrey Norris"],
      },
      {
      ...
      {
        title: "Legal",
        names: ["Christi Davisson"],
      },
      {
        title: "Intellectual Property Enforcement Lead",
        names: ["Mathias Andersson", "Teresa Lee Rodewald"],
      },
      {
        title: "Intellectual Property Enforcement Agents",
        names: [
          "Johan Hedlund",
          "Marcus Forss",
          "Matilda Åkerman",
      ...
      {
        title: "Lead Producer - Brand Experience",
        names: ["Karim Walldén"],
      },
      {
      ...
      },
      {
        ...
        names: ["Charlie Bjurström", "Petra Stenqvist"],
      },
      {
        title: "HR Advisor",
        names: ["Viktoria Petersson"],
      },
      {
        title: "Sourcer",
        names: ["Sofia Andersson"],
      },
      {
      ...
      {
        title: "Recruiters",
        names: ["Aimée Narfström", "Ida Utterström"],
      },
      {
        title: "Creative Communications Editor",
        names: ["Marsh Davies", "Tom Stone"],
      },
      {
      ...
      },
      {
        ...
        names: ["Mattias Jacob Victorin"],
      },
      {
        title: "Consumer Products Designer",
        names: ["Kelsey Ranallo"],
      },
      {
        title: "Lead Project Manager",
        names: ["Vera Mirchev"],
      ...
      {
        title: "Web Design",
        names: ["Taylor Kasony (eXcell, a division of CompuCom)"],
      },
      {
        title: "Quality Manager",
        names: ["Rob Straavaldson"],
      },
      {
        title: "Development Partner: Skybox",
        names: [
          "Ace Cheung",
          "Alex MacKay",
          "Alfonso Muñoz",
      ...
      {
        title: "Development Partner: BBI",
        names: [
          "Alex Sharp - Assistant Producer",
          "Andrew Yuennan - Programmer",
          "Anish Shenwai - Co-Op Programmer",
          "Bhavesh Gupta - Associate Programmer",
          "Branko Bajcetic - Co-Op Programmer",
          "Christina Oh - Co-Op Programmer",
          "Christopher Whitman - Programmer",
          "David McKay - Associate Producer",
          "Duarte Maia - Programmer",
          "Elizabeth Pieters - Co-Op Programmer",
          "Eric Dahl - Co-Op Programmer",
          "Erick Tavares  - Programmer",
          "Gupta Bhavesh",
          "Hugo Burd - Co-Op Programmer",
          "James Fairweather",
          "Kelsey Primar - Producer",
          "Kevin Yu - Co-Op Programmer",
          "Koki Pan - Co-Op Programmer",
          "Riley Godard - Associate Programmer",
          "Ryan LeMesurier - Lead QA Analyst",
          "Thomas Paterson - Programmer",
          "Tyler Nilsson",
          "Vidhi Shah - Designer",
          "Wes Trevor - Senior QA",
          "Youhan Guan - Programmer",
        ],
      },
      {
        title: "Development Partner: Red Lens",
        names: ["Christopher Kohnert", "Joshua Claeys", "Ryan Davison"],
      },
      {
        title: "Development Partner: Virtuosity",
        names: ["Shanthi Kanchibhotla (Virtuosity)"],
      },
      {
        title: "Front of House",
        names: ["Adam Blänning"],
      ...
      {
        title: "Product Owner",
        names: ["Johannes Söderberg"],
      },
      {
        title: "Technical Audio Developer",
        names: ["Jonatan Crafoord"],
      },
      {
        title: "Senior Financial Accountant",
        names: ["Natalie Levinsson"],
      },
      {
  ...
  {
    section: "Studios Quality Alumni",
    titles: [
      {
        title: "Quality Leads",
        names: ["Tony Harlich"],
      ...
      {
        title: "Quality Engineers",
        names: ["Akshata Trivedi"],
      },
      {
        title: "Quality Data Analysis & Engineering",
        names: ["Jeff MacDermot"],
      },
      {
        title: "Quality Analysts",
        names: ["Yi Zhao (Kforce)"],
      },
      {
        title: "Poland - Team Leads",
        names: [
      ...
      {
        title: "US Team - Software Test Engineering Leads",
        names: ["Chris James (Insight Global, Inc)"],
      },
      {
        title: "US Team - Software Test Engineers",
        names: [
      ...
      {
        title: "US Team - Test Associates",
        names: ["Brian Sears (Experis)"],
      },
      {
        title: "Lionbridge",
        names: [
          ...
          "Stanisław Grabowsk (Lionbridge)",
          "Stanisław Grabowski (Lionbridge)",
